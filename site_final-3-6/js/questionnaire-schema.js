...
export const STEPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'temperament', type: 'radio', label: 'Vous vous reconnaissez plutôt dans', options: [['adapt', 'je m’adapte vite à un changement'], ['time', 'j’ai besoin d’un peu de temps'], ['detail', 'je remarque tout de suite le moindre détail']], required: true },
